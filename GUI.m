...
% Last Modified by GUIDE v2.5 23-Jan-2015 03:50:55
...
handles.data(1, 1)=num2cell(handles.a);
...
handles.data(2, 1)=num2cell(handles.b);
set(handles.uitable2, 'Data', handles.data);
guidata(hObject,handles);
pushbutton1_Callback(hObject,eventdata,handles);
...
handles.data(4, 1)=num2cell(handles.s);
set(handles.uitable2, 'Data', handles.data);
guidata(hObject,handles);
pushbutton1_Callback(hObject,eventdata,handles);
...
handles.data(3, 1)=num2cell(handles.r);
...
handles.data(5, 1)=num2cell(handles.x0(1));
set(handles.uitable2, 'Data', handles.data);
guidata(hObject,handles);
pushbutton1_Callback(hObject,eventdata,handles);
% --- Executes during object creation, after setting all properties.
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
handles.x0(2)=get(hObject,'Value');
handles.data(6, 1)=num2cell(handles.x0(2));
set(handles.uitable2, 'Data', handles.data);
guidata(hObject,handles);
pushbutton1_Callback(hObject,eventdata,handles);
